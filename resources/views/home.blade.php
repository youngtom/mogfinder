		    ...
		    <div class="panel panel-default">
			    <div class="panel-body">
					...
					<ol>
						...
						<li>Download and install the <a href="{{ asset('/files/ItemCollector.zip') }}">MogFinder ItemCollector</a> addon.  This mod is used to collect which items you have collected. <em>(Note: currently, some mods (Cross Realm Assist and ServerHop) are known to prevent proper collection, so these may need to be disabled in order for it to work)</em></li>
